      ...
      <section className="hero">
        <div className="container">
          <div className="row">
            <Heading
              subtitle="WELCOME TO"
              title="SRG COMPUTER TRAINING INSTITUTE"
            />

            <p>
              Master your skill from Basic to Advance. Elevate your skills,
                ...
                <div className="banner-content">
                  <div className="banner-left">
                    ...
                    <div className="banner-text">
                      ...
                      <p>
                        Check your scholarship result using registration number
                        and mobile number
                      </p>
                    </div>
                  </div>
