  ...
  <div className="privacy-content">
    ...
    <div className="section">
      ...
      <div className="subsection">
        ...
        <ul style={{ listStyleType: "disc" }}>
          <li>
            Admission is confirmed only after full payment of course fees.
          </li>
          <li>
            All required documents must be submitted at the time of enrollment.
          </li>
          <li>
            SRG reserves the right to refuse admission without providing
            reasons.
          </li>
        </ul>
      </div>
      <div className="subsection">
        ...
        <ul>
          <li>
            Maintain a minimum of 90% attendance to be eligible for
            certification.
          </li>
          <li>Inform administration in advance of any planned absence.</li>
          <li>
            Repeated unexcused absences may result in termination from the
            course.
          </li>
        </ul>
      </div>
      <div className="subsection">
        ...
        <ul>
          <li>
            Maintain professionalism and decorum within institute premises.
          </li>
          <li>
            Abusive language, misbehavior, or property damage will result in
            disciplinary action.
          </li>
    ...
    <div className="section">
      ...
      <div className="subsection">
        ...
        <ul>
          ...
          <li>
            SRG may modify course duration, content, or trainers without prior
            notice.
          </li>
        </ul>
      </div>
      <div className="subsection">
        ...
        <ul>
          <li>
            All materials (presentations, videos, notes) are the intellectual
            property of SRG.
          </li>
          <li>
    ...
    <div className="section">
      ...
      <div className="subsection">
        ...
        <ul>
          <li>
            Personal data (name, contact, educational background, payment
            details) is collected for course administration.
          </li>
          <li>
            Data is used solely for communication and certification purposes.
          </li>
        </ul>
      </div>
      <div className="subsection">
        ...
        <ul>
          <li>
            SRG employs security measures to protect personal data from
            unauthorized access.
          </li>
          <li>
    ...
    <div className="section">
      ...
      <div className="subsection">
        ...
        <ul>
          <li>
            Minimum 40% aggregate marks are required to pass for Certificate.
          </li>
          <li>
            All components are mandatory. Absence in the final exam results in
            failure.
          </li>
          <li>
            Students scoring above 90% will be awarded Prize with Certificate.
          </li>
        </ul>
      </div>
    </div>
